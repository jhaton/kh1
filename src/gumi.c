...
s32 func_001BBD70(void) {
    if (cdvd_IsFileLoadPending(D_0061B950) != 0) {
        return 0;
    }
...
void func_001BC048(void) {
    ...
    func_001BD210();
    gumi = (GummiState*)WorkBuffers_Get(4);
    func_001C0370(gumi, sizeof(GummiState));
...
u8 func_001BC590(s32 index) {
    GummiBlock* block = func_001BCB58();
...
void func_001BC898(s32 enabled) {
    D_00373790 = enabled;
    if (enabled != 0) {
        func_001C0370(&D_0061B960, sizeof(GummiNode));
        D_0061BA40 = 0;
        D_0061BA48[0][0] = 0;
        D_0061BA48[0][1] = 0;
        D_0061BA48[1][0] = 0;
...
s32* func_001BCB30(void) {
    ...
    func_001BCAE8();
    gumi = WorkBuffers_Get(4);
    return &gumi->unk_0008;
}

GummiBlock* func_001BCB58(void) {
    GummiState* gumi;
...
void func_001BCCA0(GummiState* gumi) {
    gumi->unk_9B00 = 0x4000;
    gumi->unk_9B04 = 0x8000;
    gumi->unk_9B08 = 0x400;
    gumi->unk_9B0C = 0x2000;
