...
s32 VectorInterpolationTask_Update(VectorInterpolationTask* interpolation) {
    s32 status;
    f32 remainingTime;
    f32 ratio;
...
//     VectorInterpolationTask* interpolation;

//     if (0.0f >= arg0) {
//         sceVu0CopyVector(arg1[3], arg2);
//     } else {
//         pvVar1 = func_0011EEB8(&D_004FA670, 0, VectorInterpolationTask_Update);
//         pvVar1->unk_10 = arg1;
//         pvVar1->unk_44 = arg0;
//         pvVar1->unk_40 = arg0;
//         pvVar1->unk_48 = arg3;
...
void Interpolation_ClearValue(s32* value) {
    *value = 0;
}
...
void Interpolation_Initialize(void) {
