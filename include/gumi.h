...
typedef struct GummiBlock {
    ...
    /* 0x47 */ s8 unk_47;
} GummiBlock; // size: 0x48

typedef struct GummiNode {
    /* 0x000 */ u64 unk_000;
    /* 0x008 */ u64 unk_008;
    /* 0x010 */ u64 unk_010;
    /* 0x018 */ u64 unk_018;
    /* 0x020 */ struct GummiNode* unk_020;
    /* 0x024 */ char unk_024[4];
    /* 0x028 */ s32 unk_028;
    /* 0x02C */ char unk_02C[0x40];
} GummiNode; // size: 0x70
typedef struct GummiState {
    /* 0x0000 */ char unk_0000[4];
    /* 0x0004 */ s32 unk_0004;
    /* 0x0008 */ s32 unk_0008;
    /* 0x000C */ char unk_000C[0x9A6C];
    /* 0x9A78 */ GummiBlock unk_9A78;
